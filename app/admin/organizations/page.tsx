...
import { Plus, Building2, Users, Home, Eye, Loader2 } from 'lucide-react';
            ...
            <Table>
              ...
              <TableBody>
                {organizations.map((org) => (
                  <TableRow key={org.id} className="cursor-pointer hover:bg-accent/50" onClick={() => router.push(`/admin/organizations/${org.id}`)}>
